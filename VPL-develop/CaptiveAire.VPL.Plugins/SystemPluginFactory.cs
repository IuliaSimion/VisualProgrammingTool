...
using CaptiveAire.VPL.Plugins.Interaction;
    ...
    public static class SystemPluginFactory
    {
        ...
        public static IVplPlugin CreateControlPlugin()
        {
            var factories = new IElementFactory[]
            {
                ...
                new ElementFactory(PluginElementIds.For, CategoryNames.Control, "For", context => new ForStatement(context), typeof(ForStatement), description: "Repeats a block of code while the specified condition is true."),
            };
        ...
        public static IVplPlugin CreateInetaractionPlugin()
        {
            var plugin = new IElementFactory[]
                {
            ...
            return new VplPlugin("Interaction", plugin);
        }
